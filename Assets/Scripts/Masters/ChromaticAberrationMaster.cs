...
public class ChromaticAberrationMaster : MonoBehaviour
{
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        m_ComputeShader.SetFloat("red_offset", offset.x);
        m_ComputeShader.SetFloat("green_offset", offset.y);
        m_ComputeShader.SetFloat("blue_offset", offset.z);
